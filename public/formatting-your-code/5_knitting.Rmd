---
title: "Knitting to word, html and pdf"
...
![](/images/knitting.jpg?width=30pc)
...
![](/images/knitr.png?width=30pc) 

### Chunk options 

Most of the time when knitting a document, there are some chunks you will not want the code to display in. Rstudio has built in options to display just the code, just the output or neither. You can find these in the handy (R Markdown reference sheet)[https://www.rstudio.com/wp-content/uploads/2015/03/rmarkdown-reference.pdf] 

```{r Chunk example, echo=FALSE}

```

![](/images/chunkoptions.png?width=30pc)  
