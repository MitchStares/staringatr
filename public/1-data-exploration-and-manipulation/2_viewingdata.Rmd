...
```
Now we have become acquainted with our working directories and the R environment, its time to explore our newely imported data. For this, we will be using the **weeds** dataset.
...
{{% notice question %}}
**After reading in dataset, use the summary() command with the "insecticide"" dataset to answer the following questions:**  
